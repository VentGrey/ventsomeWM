...
myexitmenu = {
    { "Cerrar Sesión", function() awesome.quit() end, menubar.utils.lookup_icon("system-log-out") },
    { "Suspender", "systemctl suspend", menubar.utils.lookup_icon("system-suspend") },
    { "Hibernar", "systemctl hibernate", menubar.utils.lookup_icon("system-suspend-hibernate") },
    { "Reiniciar", "systemctl reboot", menubar.utils.lookup_icon("system-reboot") },
